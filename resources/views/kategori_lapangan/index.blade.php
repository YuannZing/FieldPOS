    ...
    <div class="col-lg-12">
        <div class="box">
            <div class="box-header with-border">
                <button onclick="addForm('{{ route('kategori_lapangan.store') }}')" class="btn btn-success btn-xs btn-flat"><i class="fa fa-plus-circle"></i> Tambah</button>
            </div>
...
<script>
    ...
    function editForm(url) {
        ...
        $('#modal-form [name=nama_kategori_lapangan_]').focus();
